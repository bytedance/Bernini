...
parser.add_argument(
    '--vlm_config', default='/mnt/bn/video-editing/rayeeli/Models/opensouce/models/Qwen2.5-VL-7B-Instruct', type=str
)
parser.add_argument(
    '--vae_config', default='/mnt/bn/video-editing/sunmingzhen.triz/pretrained_models/Wan2.2-T2V-A14B-Diffusers/vae', type=str
)
parser.add_argument(
